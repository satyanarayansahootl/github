...
$(document).ready(function () {
    ...
    //         stroke: { curve: "smooth" },
    //         series: [
    //             { name: "", color: "#ef151e", data: [45, 60, 75, 51, 42, 42, 30] },
    //             { name: "", color: "#70C4CF", data: [24, 48, 56, 32, 34, 52, 25] },
    //         ],
    ...
    if ($("#school-area").length > 0) {
        var options = {
            ...
            series: [
                { name: "Teachers", color: "#3D5EE1", data: [45, 60, 75, 51, 42, 42, 30] },
    ...
    if ($("#bar").length > 0) {
        var optionsBar = {
            ...
            series: [
                { name: "", color: "#ef151e", data: [420, 532, 516, 575, 519, 517, 454, 392, 262, 383, 446, 551] },
                { name: "", color: "#3D5EE1", data: [336, 612, 344, 647, 345, 563, 256, 344, 323, 300, 455, 456] },
            ],
